...
- [! + Tab] - We will get a whole format of our HTML file.
- [2 times Tab] - The cursor will be placed between title tags through this.
- [Cmd + K] - It can add or remove any division in any HTML file.
